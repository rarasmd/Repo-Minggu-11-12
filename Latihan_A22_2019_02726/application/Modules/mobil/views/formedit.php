			...
			<div class="col-md-12">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<!-- <form action="<?php //echo base_url('home/tambahmobil'); 
											?>" method="post" class="form-horizontal"> -->

						<?php echo form_open('mobil/home/updatemobil/' . $db->kdmobil, ['class' => 'form-horizontal', 'method' => 'post']); ?>
						...
						<div class="form-group">
							<div class="btn-form col-sm-12">
								<a href="<?php echo base_url('mobil/home/lihatdata'); ?>"><button type="button" class='btn btn-default'>Batal</button></a>
